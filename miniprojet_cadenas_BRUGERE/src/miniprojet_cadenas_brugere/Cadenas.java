...
public class Cadenas extends javax.swing.JFrame {
    ...
    private void up_chiffre_1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_up_chiffre_1ActionPerformed
        ...
        texte_chiffre_1.setText(String.valueOf(nombre));
    ...
    private void up_chiffre_4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_up_chiffre_4ActionPerformed
      String texte= texte_chiffre_4.getText();
        int nombre = Integer.parseInt(texte);
        nombre +=1;
        if(nombre<0){
        nombre=9;
        }
        texte_chiffre_4.setText(String.valueOf(nombre));
    ...
    private void bouton_testerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bouton_testerActionPerformed
        ...
        proposition[0] = Integer.parseInt(texte_chiffre_1.getText());
        proposition[1] = Integer.parseInt(texte_chiffre_2.getText());
        proposition[2] = Integer.parseInt(texte_chiffre_3.getText());
        proposition[3] = Integer.parseInt(texte_chiffre_4.getText());
